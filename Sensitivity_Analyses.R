...
wd = 'C:/Users/mbulla/Documents/Dropbox/Science/Projects/MS/Kubelka_et_al_rebuttal/'
outdir = 'C:/Users/mbulla/Documents/Dropbox/Science/Projects/MS/Kubelka_et_al_rebuttal/'
...
# prepare
b = readWorksheetFromFile(paste(wd, 'additional data/Kubelka et al._2018_Science_additional datafile_1.xlsx',sep = ""), colTypes = 'character', sheet = "DATA")	
...
b$N.nests = as.numeric(b$N.nests)
b$"Failed_together." = as.numeric(b$"Failed_together.")
b$ln_N_nests = log(b$N.nests)
